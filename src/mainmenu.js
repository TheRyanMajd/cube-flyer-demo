...
class MainMenu extends GameObject {
	...
	showUI() {
		...
		this.instructionsText.text = "press any key to play"; //TODO: add "press space or mouse1 to play"
		this.instructionsText.fontFamily = "Impact";
		this.instructionsText.color = "#ff0000ff";
		...
		this._blinkInterval = setInterval(() => {
			...
			this.instructionsText.color = this.instructionsText.color === "#ff0000ff" ? "white" : "#ff0000ff";
		}, 500);
